<%@ page import="kr.or.ddit.buyer.controller.BuyerInsertController" %>	
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<%@ taglib uri="http://www.springframework.org/tags/form" prefix="form"%>
<form:form method="post" modelAttribute="${BuyerInsertController.MODELNAME }">
	...
	<table class="table table-bordered">
		...
		<tr>
			<th>분류코드</th>
			<td>
				<form:select path="buyerLgu" cssClass="form-select">
